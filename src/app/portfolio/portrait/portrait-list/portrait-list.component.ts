...
export class PortraitListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    this._picturesSubscription = this._portfolioService.getAllPortfolios('portrait').pipe(
      flatMap(
        pictures => {
