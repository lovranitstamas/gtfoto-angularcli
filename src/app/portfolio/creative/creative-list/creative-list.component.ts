...
export class CreativeListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    this._picturesSubscription = this._portfolioService.getAllPortfolios('creative').pipe(
      flatMap(
        pictures => {
