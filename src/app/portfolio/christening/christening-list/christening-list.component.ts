...
export class ChristeningListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    this._picturesSubscription = this._portfolioService.getAllPortfolios('christening').pipe(
      flatMap(
        pictures => {
